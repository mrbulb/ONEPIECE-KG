...
processed_moegirl_onepiece_entities_file = './processed_moegirl_onepiece_entries.txt'
output_dir = './cndbpedia_onepiece'

cndbpedia_onepiece_entities_list_file = os.path.join(output_dir, 'cndbpedia_onepiece_entities_list.txt')
moelgirl_cndbpedia_entities_mapping_file = os.path.join(output_dir, 'moelgirl_cndbpedia_entities_mapping.json')
...
if __name__ == "__main__":
    ...
    with open(processed_moegirl_onepiece_entities_file) as f:
    	...
    	mention_name_list = [item.strip() for item in mention_name_list] # 去除末尾换行符
